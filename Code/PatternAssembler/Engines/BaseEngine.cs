...
namespace PatternAssembler
{
   public abstract class BaseEngine
   {
      ...
      /// <summary>
      /// Write a custom code symbol for a SARB ID ([-2343443], [345435])
      /// EnginePatternWriter.WriteNumericConstant(new CustomSarbId(EngineBuffer.FlushKeyword().Value, 1), EngineCurrentKeyPress);
      /// </summary>
      protected abstract void WriteSarbId();
