...
namespace PatternBuilder
{
   public class MeasureEngine : BaseEngine
   {
      ...
      private int sarb_id_incrementor = 0;
      ...
      {
         EnginePatternWriter.WriteSarbId(new MeasureSarbIdSegment(EngineBuffer.Flush(), ++sarb_id_incrementor), EngineCurrentKeyPress);
      }
